...
Add these values to the .env file on your Moolias server:
...
Keep the secret private. Do not share it or commit it to Git.

From the Moolias installation directory, run:
