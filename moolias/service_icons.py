...
SERVICE_ICONS: tuple[ServiceIcon, ...] = (
    ...
    _icon("deutschebahn", "Deutsche Bahn", "DB", "red", ("deutschebahn", "deutsche bahn", "bahn")),
    ...
    _icon("heroku", "Heroku", "H", "violet", ("heroku",)),
    ...
    _icon("lufthansa", "Lufthansa", "L", "blue", ("lufthansa", "milesandmore", "miles and more")),
    _icon("mailchimp", "Mailchimp", "M", "amber", ("mailchimp", "mail chimp")),
    ...
    _icon("microsoft", "Microsoft", "M", "blue", ("microsoft", "office", "outlook", "azure"), False),
    ...
    _icon("plex", "Plex", "P", "amber", ("plex",)),
    _icon("protonmail", "Proton Mail", "P", "violet", ("protonmail", "proton mail", "proton")),
    ...
    _icon("snapchat", "Snapchat", "S", "amber", ("snapchat",)),
